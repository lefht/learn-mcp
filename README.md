...
- **How:** I added two placeholder PNGs (`open browser.png` and `results.png`) that represent the workflow: opening the browser to the example page, then viewing the results after running the example.
- **Regenerate images:** Run `python3 generate_images.py` to rewrite the placeholder PNGs.
